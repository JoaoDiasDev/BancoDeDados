...
SELECT NOME, SEXO, ENDERECO
FROM CLIENTE
WHERE EMAIL = NULL; /* Errado Null não pode ser igualado */
...
/* FOREIGN KEY=FK_A QUAL TABELA PERTENCE_ONDE ELA ESTA */
...
/*
	 ...
	 TOTALIDADE - DEPENDER DA TOTALIDADE DA CHAVE

	 TERCEIRA FN

	 TRANSITIVA - CAMPOS NÃO CHAVE QUE DEPENDEM DE OUTROS CAMPOS NÃO CHAVE SE TORNAM OUTRA TABELA
